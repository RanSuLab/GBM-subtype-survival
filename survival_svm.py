...
def selection(feature_path,label_path):
    ...
    for k in range(1,X.shape[1]+1,1):
        ...
        df_to_save.to_csv('D:/aa_papar/segmentation/data/data/fs_unet_survival_inter.csv', mode='a+', header=False)
...
def svm(feature_path,label_path):
    ...
    print('short:',a_ACC,'intermediate:', b_ACC,'long:', c_ACC)


feature_path = './fs_unet_survival.csv'
label_path = './survival_label.csv'
